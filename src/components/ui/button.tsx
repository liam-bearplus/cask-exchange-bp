...
const buttonVariants = cva(
    "inline-flex items-center justify-center gap-x-1 whitespace-nowrap px-3 rounded-md text-sm font-medium transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:bg-bg-disable disabled:text-typo-disable [&_svg]:pointer-events-none [&_svg]:shrink-0",
    {
        variants: {
            variant: {
                destructive:
