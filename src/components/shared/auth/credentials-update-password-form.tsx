...
const CredentialsUpdatePasswordForm = () => {
  const updatePasswordMutation = useMutation({
    ...
    mutationFn: ({ data: data }: { data: TUpdatePassword }) => updatePassword(data),
  });
  ...
  const UpdatePasswordButton = () => {
    return (
      <Button disabled={isDisableButton || updatePasswordMutation.isPending} className="w-full" variant="default" type="submit">
