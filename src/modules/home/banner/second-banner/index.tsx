...
export const SecondaryBanner: React.FC<{ data: TBannerItem }> = ({ data }) => (
    <div className="tablet:row-span-2 relative row-span-1 flex items-center overflow-hidden rounded-[0.625rem] p-[2rem]">
        <ImagePlaceholder
            src={data.imageSrc}
        ...
        <div className={`mt-auto flex flex-col ${data.maxWidthClass}`}>
            <h2 className="text-white-main mb-4 text-3xl font-medium">
                {data.title}
            </h2>
            <Button
